<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT userName, userProfession, userPic FROM artistes WHERE userID =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE artistes 
									     SET userName=:uname, 
										     userProfession=:ujob, 
										     userPic=:upic 
								       WHERE userID=:uid');
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Modifier Artiste <a class="btn btn-default" href="index.php"> Tous les artistes </a></h1>
    </div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
    	<td><label class="control-label">NomArtiste</label></td>
    ...
    <tr>
    	<td><label class="control-label">ImageArtiste</label></td>
        <td>
